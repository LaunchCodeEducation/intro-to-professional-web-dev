...
Notice that when we put a conditional inside another conditional, the body of the nested conditional is indented by two tabs, and not just one. This convention allows us to easily determine which code is part of which conditional, by looking at the indentation level.
