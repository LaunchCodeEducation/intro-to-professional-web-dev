...
4. Query the user for the starting fuel level.
    Validate that the user enters a positive, integer value greater than
...
#. Use a final loop to monitor the fuel status and the altitude of the shuttle.
    | a. Each iteration, decrease the fuel level by 100 units for each
        astronaut aboard.
    | b. Each iteration, increase the altitude by 500 kilometers.
